        <footer>
            ...
            ?>
                    <aside class="mythemes-default-content">
                        <div class="container">
                            <div class="row">
                              <!--  On veut que 3 sideBar, celle là, c'est pour les tests
            ...
            <div class="mythemes-dark-mask">
               <!-- <div class="container mythemes-social">
                    <div class="row">
                        ...
                        ?>
                        <div class="col-lg-12"> //On veut pas les logos des réseaux sociaux
                            <?php
                                if( !empty( $vimeo ) ){
                ...
                <div class="mythemes-copyright">
                    <div class="container">
                        <div class="row">
                            <div class="col-lg-12">
                                <p>
                                    <span class="copyright"><?php echo mythemes_validate_copyright( get_theme_mod( 'mythemes-copyright' , sprintf( __( 'Copyright &copy; %s %s' , 'cannyon' ) , date( 'Y' ) , esc_html( get_bloginfo( 'name' ) )) ) ); ?></span>
                                </p>
                            </div>
                        </div>
                    </div>
