...
Description: <strong>Bring Your Brand Forward.</strong> Customize and enhance the WordPress Login screen.
Version: 3.2
*/
?>
    <input type="hidden" id="loginform_title_sml" value="<?php echo _e("S'identifier"); ?>">
    <input type="hidden" id="lostpasswordform2_title_sml" value="<?php echo _e("Mot de passe oublié"); ?>">
    <input type="hidden" id="lostpasswordform1_title_sml" value="<?php echo _e("Veuillez renseigner vos informations. Vous recevrez un nouveau mot de passe par email."); ?>">
    <input type="hidden" id="resetpassform_title_sml" value="<?php echo _e("Entrer un nouveau mot de passe ci-dessous."); ?>">
    <input type="hidden" id="registrationform_title_sml" value="<?php echo _e("Créez votre compte"); ?>">
<?php
...
define( 'BLS_LOCATION',     3 ); //used to change location of login form on the page. See documentation for value meanings

define( 'BLS_FULL_SCREEN',  true ); // if using a repeatable background image, set this to false.

define( 'BLS_BG_IMG',       'carriere.jpg' ); // place your 'background'      image in the '/assets/i/background_image' folder.
define( 'BLS_HDR_LOGO',     'nouveauLogoSite.png' );      // place your 'header logo'     image in the '/assets/i/logo_main'        folder.
define( 'BLS_RHDR_LOGO',    'nouveauLogoSite.png' );   // place your 'responsive logo' image in the '/assets/i/logo_responsive'  folder.
